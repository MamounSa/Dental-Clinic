    ...
    public partial class ms : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DentalModels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DentalModels_MedicalRecords_MedicalRecordId",
                        column: x => x.MedicalRecordId,
                        principalTable: "MedicalRecords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DentalModels_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorId = table.Column<int>(type: "int", nullable: false),
                    DentalModelId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DentalTreatments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DentalTreatments_DentalModels_DentalModelId",
                        column: x => x.DentalModelId,
                        principalTable: "DentalModels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DentalTreatments_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DentalModels_MedicalRecordId",
                table: "DentalModels",
                column: "MedicalRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_DentalModels_PatientId",
                table: "DentalModels",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_DentalTreatments_DentalModelId",
                table: "DentalTreatments",
                column: "DentalModelId");

            migrationBuilder.CreateIndex(
                name: "IX_DentalTreatments_DoctorId",
                table: "DentalTreatments",
                column: "DoctorId");
